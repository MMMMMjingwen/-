...
$(function(){
    ...
    // $(document).ready(function(){
        ...
        turnplate.restaraunts = [ "马尔代夫", "iphoneXR", "车载冰箱", "行车记录仪", "车载充电器","自拍杆","车载手机支架","全家福", "谢谢参与",'酒卡'];
        turnplate.colors = ["#FBDB00", "#FACA00", "#FBDB00", "#FACA00","#FBDB00", "#FACA00","#FBDB00","#FACA00","#FFEB64","#FACA00"];
        ...
        var rotateFn = function (item, txt,data){
            ...
            $('#wheelcanvas').rotate({
                ...
                callback:function (){
                    ...
                    //     $("#jiangpin").html('免费全家福');
                    //   $('#family').css('visibility','visible')
                        // save();
                    }else  if(txt.indexOf("酒卡")>=0){
                        grape()
